...
const THANKYOU_MESSAGE =
  "ขอบคุณที่มาใช้บริการ Dermalyze ยินดีช่วยเหลือเสมอนะคะ ขอให้หายไว ๆ ค่ะ 💜";
...
*หากมีสิวอักเสบเป็นหนองจำนวนมาก เจ็บมาก หรือเริ่มมีแผลเป็นชัด ควรพบแพทย์เพื่อตรวจและรักษาเพิ่มเติมนะคะ*`,
  ...
  Bullous: {
    info: `"ตุ่มน้ำพองจากภูมิคุ้มกัน" (Bullous)
- เป็นโรคผิวหนังเรื้อรังที่เกิดจากภูมิคุ้มกันของร่างกายทำลายโครงสร้างระหว่างชั้นผิว
- ทำให้เกิดตุ่มน้ำตึงใสหรือตุ่มน้ำพองบนผิวปกติหรือผิวที่แดง
- มักพบในผู้สูงอายุ โดยเฉพาะอายุเกิน 60 ปี
- ตำแหน่งที่พบบ่อย เช่น ข้อพับ หน้าท้อง ต้นขา และอาจมีแผลในปากหรือเยื่อบุได้`,
...
- เป็นโรคติดเชื้อไวรัส varicella ติดต่อกันง่ายจากการไอ จาม หรือสัมผัสตุ่มน้ำ
- มีระยะฟักตัวประมาณ 2–3 สัปดาห์
- มักเริ่มด้วยไข้ต่ำ/ไข้สูง ปวดเมื่อย แล้วตามด้วยผื่นแดง → ตุ่มน้ำใส → ตุ่มขุ่นคล้ายหนอง → สะเก็ด
- ผื่นมักกระจายที่หน้า ลำตัว แผ่นหลัง และอาจมีตุ่มในปาก`,
...
- เป็นกลุ่มโรคผิวหนังอักเสบเรื้อรังที่มีอาการคันเด่น
...
- ลักษณะผื่นแตกต่างกันตามระยะ:
  ...
  • ระยะเรื้อรัง: ผิวหนาหนาขึ้นจากการเกา มีรอยขีดข่วน`,
    care: `การดูแลเบื้องต้นสำหรับ "ผิวหนังอักเสบ/เอ็กซีมา"
...
- เป็นโรคผิวหนังอักเสบเรื้อรังจากระบบภูมิคุ้มกัน มีปัจจัยพันธุกรรมร่วม
- ผื่นลักษณะเป็นปื้นแดง ขอบชัด มีขุย/สะเก็ดสีขาวเงินหนาปกคลุม
- มักพบที่ข้อศอก เข่า หลังส่วนล่าง หนังศีรษะ และอาจมีรอยที่เล็บหรือข้ออักเสบร่วม
- ผื่นเป็น ๆ หาย ๆ แต่ไม่ใช่โรคติดต่อ`,
    care: `การดูแลเบื้องต้นสำหรับ "สะเก็ดเงิน"
1) ทามอยส์เจอไรเซอร์สม่ำเสมอ ลดความแห้งและลอกของผิว
2) หลีกเลี่ยงการแกะ ลอก ขูดสะเก็ดเอง เพราะอาจกระตุ้นให้ผื่นเห่อเพิ่ม (Koebner phenomenon)
3) ลดปัจจัยกระตุ้น เช่น ความเครียด การอดนอน การดื่มแอลกอฮอล์ การสูบบุหรี่
4) ยาทากลุ่มสเตียรอยด์ วิตามินดี หรือยากลุ่มอื่น ควรใช้ตามคำแนะนำแพทย์ผิวหนัง
5) กรณีผื่นเยอะเกิน 10% ของพื้นที่ผิว อาจต้องใช้ยากิน ยาฉีด หรือการฉายแสงภายใต้การดูแลของแพทย์
...
- เกิดจากเชื้อไวรัส varicella-zoster ตัวเดียวกับอีสุกอีใสที่แฝงตัวอยู่ในปมประสาท
- เมื่อภูมิคุ้มกันอ่อนลง เชื้อจะถูกกระตุ้น ทำให้เกิดผื่นแดงและตุ่มน้ำเป็นกลุ่ม เรียงตามแนวเส้นประสาท
- มักมีอาการปวดแสบปวดร้อน/เจ็บคล้ายไฟช็อต นำมาก่อนหรือพร้อมผื่น
- มักเกิดข้างเดียว เช่น ลำตัวรอบเอว/ลำตัว หน้าท้อง หน้าอก หรือใบหน้า`,
    care: `การดูแลเบื้องต้นสำหรับ "งูสวัด"
1) พบแพทย์ให้เร็วที่สุด โดยเฉพาะภายใน 72 ชั่วโมงแรก เพื่อพิจารณายาต้านไวรัส (ช่วยให้ผื่นหายเร็วและลดโอกาสปวดปลายประสาทเรื้อรัง)
2) อย่าเจาะ/แกะตุ่มน้ำเอง รักษาความสะอาดผิวหนัง ซับให้แห้ง
3) สามารถใช้ผ้าชุบน้ำสะอาดเย็น ๆ ประคบบรรเทาความปวดแสบได้บางส่วน
4) ใช้ยาลดปวดตามแพทย์แนะนำ และอาจต้องใช้ยาลดปวดปลายประสาทในบางราย
5) หลีกเลี่ยงการสัมผัสใกล้ชิดกับหญิงตั้งครรภ์ ทารกแรกเกิด และผู้มีภูมิคุ้มกันบกพร่อง

***ควรพบแพทย์ด่วน/ฉุกเฉิน*** หาก:
- ผื่นขึ้นบริเวณใบหน้า ใกล้ตา หรือในตา (เสี่ยงต่อการมีปัญหาที่ดวงตา)
- ปวดมากมาก หรือมีไข้สูง หนาวสั่น
...
- เป็นก้อนนูน/ปุ่มแข็งบนผิวหนัง มักพบที่มือ เท้า เข่า ข้อศอก หรือบริเวณที่รับน้ำหนัก/เสียดสี
- ส่วนใหญ่ไม่เจ็บ ยกเว้นตำแหน่งที่รับแรงกด เช่น ฝ่าเท้า
- สามารถติดต่อได้จากการสัมผัสโดยตรง โดยเฉพาะผิวที่มีแผลถลอก`,
    care: `การดูแลเบื้องต้นสำหรับ "หูด"
1) หลีกเลี่ยงการแกะ ขูด หรือบีบหูดเอง เพราะอาจทำให้ลาม/ติดเชื้อเพิ่ม
2) หากอยู่ที่เท้า พยายามใส่รองเท้าที่นุ่มพอดี ไม่บีบหรือกดจุดเดิมซ้ำ ๆ
3) มีวิธีรักษาหลายแบบ เช่น ยาทากรดซาลิไซลิก การจี้ไอเย็น (ไนโตรเจนเหลว) การจี้ไฟฟ้า เลเซอร์ หรือผ่าตัด ขึ้นกับตำแหน่งและขนาด
...
- มีหลายก้อน หรือสงสัยเป็นบริเวณอวัยวะเพศ`,
  },

  NormalSkin: {
    info: `ผลการประเมิน ผิวปกติ / ไม่พบลักษณะโรคผิวหนังที่เด่นชัด
จากรูปที่ส่งมา ระบบไม่พบลักษณะของสิว ผื่นแดงรุนแรง ตุ่มน้ำ ปื้นหนาเป็นขุย หรือความผิดปกติเด่นชัดที่เข้าได้กับโรคในชุดนี้
...
• อาจเป็นโรคผิวหนังชนิดอื่นที่ไม่ได้อยู่ในชุดโรคที่ระบบถูกฝึกมา`,
    care: `คำแนะนำเมื่อระบบจำแนกไม่ได้ชัดเจน
1) หากผื่น/ตุ่มมีอาการคันเล็กน้อยและไม่ลามมาก อาจสังเกตอาการไปก่อน 1–2 วัน
2) หลีกเลี่ยงการเกา แกะ บีบ หรือทายาแรง ๆ เอง เช่น สเตียรอยด์เข้มข้น โดยไม่ได้รับคำแนะนำจากแพทย์
3) หากผื่นลามเร็ว ปวด แสบ ร้อน มีไข้ร่วม หรือมีน้ำเหลือง/หนอง ควรพบแพทย์ผิวหนังเพื่อตรวจเพิ่มเติม

*เนื่องจากระบบนี้เป็นเพียงตัวช่วยเบื้องต้น ไม่สามารถแทนการวินิจฉัยโดยแพทย์ได้นะคะ*`,
  },
};
...
function buildQuestionMessages(qIndex, total, q) {
  ...
  const header =
    ...
    (optionsText
      ? `\n\nตัวเลือก:\n${optionsText}\n\n` +
        `(กดปุ่มด้านล่าง หรือพิมพ์เลขคำตอบ เช่น 1, 2, 3 ได้เลยค่ะ)`
      : "");
  ...
  const quickItems = q.options.map((opt, i) => ({
    ...
    action: {
      type: "message",
      // ใช้เลขสั้น ๆ เพื่อไม่ให้ label เกิน 20 ตัวอักษร
      label: `${i + 1}`,
